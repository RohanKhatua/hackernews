...
const config = {
  "generator": {
    ...
    "output": {
      "value": "/Users/rohankhatua/Developer/hackernews-clone/lib/generated/prisma",
      "fromEnvVar": null
    },
    "config": {
      "engineType": "library"
  ...
  "inlineDatasources": {
    "db": {
      "url": {
        ...
        "value": "postgresql://RohanKhatua:qletJ4pVy0QT@ep-summer-math-72190677-pooler.us-east-2.aws.neon.tech/hackernews-db?sslmode=require"
      }
    }
  },
  "inlineSchema": "// This is your Prisma schema file,\n// learn more about it in the docs: https://pris.ly/d/prisma-schema\n\ngenerator client {\n  provider = \"prisma-client-js\"\n  output   = \"../lib/generated/prisma\"\n}\n\ndatasource db {\n  provider = \"postgresql\"\n  url      = env(\"DATABASE_URL\")\n}\n\nmodel Subscriber {\n  id        String   @id @default(uuid())\n  email     String   @unique\n  name      String?\n  createdAt DateTime @default(now())\n  active    Boolean  @default(true)\n}\n",
  "inlineSchemaHash": "d9870e209fca96a2fb76d04bdd75463a1c54ba087c9e69af5932d1bb6e7c723a",
  "copyEngine": true
}
config.dirname = '/'
