      ...
      <div className="container flex h-14 max-w-screen-2xl items-center px-4 md:px-6">
        <div className="flex items-center">
          ...
          <Sheet>
            ...
            <SheetContent side="left" className="w-[240px] sm:w-[300px]">
              <div className="flex flex-col space-y-4 mt-6">
                ...
                <Link
                  href="/recommended"
                  className={`text-base py-2 px-4 rounded-md hover:bg-secondary ${isActive("/recommended") ? "font-medium" : "text-muted-foreground"}`}
                >
                  recommended
                </Link>
          ...
          <nav className="hidden md:flex items-center space-x-4 text-sm font-medium">
            ...
            <Link
              href="/recommended"
              className={`transition-colors hover:text-primary ${isActive("/recommended") ? "text-primary" : "text-muted-foreground"}`}
            >
              recommended
            </Link>
